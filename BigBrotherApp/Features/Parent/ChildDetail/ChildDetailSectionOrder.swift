...
enum ChildDetailSection: String, Codable, CaseIterable, Identifiable {
    ...
    case pendingAppReview = "pendingAppReview"
    ...
    var displayName: String {
        ...
        case .appTimeLimits: return "Allowed Apps"
        case .pendingAppReview: return "Pending App Review"
    ...
    var icon: String {
        ...
        case .pendingAppReview: return "hand.raised"
